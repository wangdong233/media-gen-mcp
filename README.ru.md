...
| **Карточки** `generate_card` | «Сделай OG-карточку для шеринга к этой статье» | OG / социальные / карточки с цитатами (Satori → PNG, по умолчанию 1200×630) |
