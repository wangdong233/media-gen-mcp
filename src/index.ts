  ...
  return [
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          seed: { type: "number", description: "Seed for reproducible results (provider=flow / provider=pixverse / provider=siliconflow pass-through; siliconflow n>1 → seed+i per image). Other providers ignore it with a warning." },
