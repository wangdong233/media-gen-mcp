    ...
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          provider: { type: "string", default: videoHead, description: "Provider used at task creation: 'agnes' / 'zhipu' / 'flow' / 'pixverse' / 'gemini' (web-UI CDP channel; subscription compute quota, no per-clip credits) — defaults to the video provider chain head. create_video responses carry provider_used; pass it back here to poll the right backend." },
        },
      },
    },
    {
