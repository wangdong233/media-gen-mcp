...
> **配套调研**：更深入的模型/价格/开源对比见 [`doc/../渠道/Provider扩张路线图.md`](../渠道/Provider扩张路线图.md) 的智谱(Zhipu)节。
...
> [!NOTE]
> 国际版部分模型/价格与国内有差异（如 CogView-4 国际 $0.01/图、CogVideoX-3 国际 $0.20/视频）；免费模型 `cogview-3-flash` / `cogvideox-flash` 国际版同样免费。详见 [`doc/../渠道/Provider扩张路线图.md`](../渠道/Provider扩张路线图.md) 智谱节的「价格速查表」。
