...
try {
  ...
  console.log("[G2] 21 工具齐全(pares5 M2 +extract_table/analyze_chart/describe_image;pares6 +list_vision_capabilities/extract_pdf/get_pdf;P0-5 +generate_interactive_diagram;P0-5B +generate_nested_diagram)");
