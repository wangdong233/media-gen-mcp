...
try {
  ...
  console.log("[G2] 12 工具齐全");
  eq(tools.map((t) => t.name).sort(), ["create_video", "generate_card", "generate_chart", "generate_diagram", "generate_formula", "generate_icon", "generate_image", "generate_qrcode", "get_video", "list_models", "render_svg", "render_video"], "12 工具齐全");
