...
| **Cartes** `generate_card` | « Fais une carte de partage avec un fond en **dégradé violet-bleu** » | Cartes OG / sociales / de citation (Satori → PNG, 1200×630 par défaut, **CJK pris en charge automatiquement**, **fond uni/dégradé**) |
